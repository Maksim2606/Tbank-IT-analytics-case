...
- [`ТБанкКейс_Гончаренко.pdf`](/ТБанкКейс_Гончаренко.pdf) - pdf-файл, содержащий описание структуры хранения данных.
- [`specs_case.yml`](/specs_case.yml) - спецификация API в формате OpenAPI. 
